...
(function () {
  ...
  (function frame(now) {
    ...
    var ry = t * 24 + sf * 360 + px * 26;           // tour complet sur la page + pointeur
    var rx = -14 + py * 12 + Math.sin(t * 0.9) * 3; // léger tangage
    var bob = Math.sin(t * 1.4) * 5;
    var s = 1 + Math.sin(sf * Math.PI) * -0.18;     // un peu plus petite au milieu de la page
